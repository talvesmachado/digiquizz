...
define([
	...
	var PlayerView = Backbone.View.extend({
		...
		badRequestHandler: function() {
			...
			tl.add([
				TweenMax.to(cible, 0.3, {
					css: {
						backgroundColor: '#f36161'
					}
				}),
				TweenMax.fromTo(cible, 0.1, {
					repeat: 5,
					left: -2
				}, {
					repeat: 5,
		...
		goodRequestHandler: function() {
			...
			tl.add([
				TweenMax.to(cible, 0.3, {
					css: {
						backgroundColor: '#d6f361'
					}
				}),
				TweenMax.fromTo(cible, 0.3, {
					rotation: 0
				}, {
					rotation: 360
				})
		...
		removeTrigger: function() {
			var that = this;
			var tl = new TimelineMax();
			tl.add(TweenMax.fromTo($(this.el), 0.4, {
				css: {
					opacity: 1,
					paddingTop: 0
				}
			...
			tl.add(TweenMax.to($(this.el), 0.4, {
				css: {
					width: 0
				},
				onComplete: function() {
